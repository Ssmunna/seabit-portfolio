...
const TourInclusionsExclusionsAccordion = ({ title, inclusions, exclusions, icon }) => {
    ...
    return (
        ...
        >
            ...
            <div className="w-full px-10 text-[#00026E] overflow-y-auto space-y-4">
                <div>
                    {
                        inclusions && (
                            inclusions.map((inc) => (
                                <div key={inc.id} className={`flex items-center gap-x-3`}>
                ...
                <div>
                    {
                        exclusions && (
                            exclusions.map((exc) => (
                                <div key={exc.id} className={`flex items-center gap-x-3`}>
...
export default TourInclusionsExclusionsAccordion;
