...
const packageData = [
    {
        ...
        imageUrl: '/assets/images/package7.webp',
    },
    {
        id: 2,
...
const PopularUmrahPackage = () => {
    return (
        <div className="py-[40px] container">
            <div className="text-center mt-12">
                <p className="text-blue-600">Choose your Umrah Package</p>
                <h2 className="text-3xl font-bold">Most Popular Umrah Packages</h2>
            </div>
                        ...
                        <div className="mt-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <div className="mt-4 text-center">
                                    <button className="bg-blue-900 text-white capitalize py-2 px-6 rounded-lg hover:bg-blue-800">
                                        book now
                                    </button>
                                </div>
                            </div>
...
export default PopularUmrahPackage
