...
const Page = ({ data }) => {
    ...
    return (
        <Main>
            <div className="flex items-center text-white h-[728px]  bg-[url('/assets/images/aboutMyCompany/aboutMyCompany.png')] w-full bg-cover bg-[position:70%_center]">
                <div className="w-full px-5">
                    <div className="max-w-[1250px] m-auto text-[46px] ">
                        <h3 className="font-[700]">About My Company</h3>
                    </div>
                </div>
            </div>
